...
public class StringUtil {
    ...
    public static String getFirstAndIndexChineseCharacter(String str, Integer index){
        ...
        char[] words = str.toCharArray();
        if (null == index || index.equals(0)){
            return String.valueOf(words[0]);
        }
        if (words.length <= index){
            return String.valueOf(words[0]) + String.valueOf(words[words.length - 1]);
        }else {
            return String.valueOf(words[0]) + String.valueOf(words[index]);
        }
    ...
    public static String getMD5(String str) {
        ...
        try {
            ...
            md5.update(str.getBytes(CommonConstant.UTF8));
